...
public class FactoryMazeBuilder implements MazeBuilder {
   ...
   * 
   * @param roomNumber1
   *          specifies the room number of the first room
   * @param roomNumber2
   *          specifies the room number of the second room
   * @param dir
   *          specifies the side of the first room at which the door will be
   *          located the second room will be on the other side of the door.
   */
  public void buildDoor(int roomNumber1, int roomNumber2, Direction dir,
      boolean open) {
    if (maze == null) {
      newMaze();
    }
    ...
    if (room1 != null && room2 != null && dir != null) {
