...
public class ScribbleCanvas extends JPanel {
  ...
  public BasicStroke getCurThickness() {
    return this.curThickness;
  }

  public void setCurThickness(Float thickness){
    System.out.println("Set cur thickness");
    curThickness = new BasicStroke(thickness);
  }
  ...
  protected BasicStroke curThickness = new BasicStroke();
