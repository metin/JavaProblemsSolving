...
//    Door door8 = makeDoor(room1, room4);
    ...
    room10.setSide(Direction.EAST, makeWall());
    ...
    room11.setSide(Direction.WEST, makeWall());
    
    room12.setSide(Direction.NORTH, makeWall());
    room12.setSide(Direction.EAST, makeWall());
    ...
    room13.setSide(Direction.WEST, makeWall());
    
    room14.setSide(Direction.NORTH, makeWall());
    room14.setSide(Direction.EAST, makeWall());
    room14.setSide(Direction.SOUTH, makeWall());
    room14.setSide(Direction.WEST, makeWall());
    
    room15.setSide(Direction.NORTH, makeWall());
    room15.setSide(Direction.EAST, makeWall());
    ...
    room17.setSide(Direction.EAST, makeWall());
    room17.setSide(Direction.SOUTH, makeWall());
    room17.setSide(Direction.WEST, makeWall());

    room18.setSide(Direction.NORTH, makeWall());
    room18.setSide(Direction.EAST, makeWall());
    room18.setSide(Direction.SOUTH, makeWall());
    room18.setSide(Direction.WEST, makeWall());    
    
    room19.setSide(Direction.NORTH, makeWall());
    room19.setSide(Direction.EAST, makeWall());
    room19.setSide(Direction.SOUTH, makeWall());
    room19.setSide(Direction.WEST, makeWall());

    room20.setSide(Direction.NORTH, makeWall());
    room20.setSide(Direction.EAST, makeWall());
