...
REM jdbc\demo\samples\generic\Inheritance\Inheritance3 on Windows platform
REM
...
:Inheritance3
del *.class
%JAVAC% -classpath %CLASSPATH% -g Inheritance3.java
%JAVA% -classpath %CLASSPATH% -DJDBC_URL=%JDBC_URL% Inheritance3
goto end
:end
endlocal
